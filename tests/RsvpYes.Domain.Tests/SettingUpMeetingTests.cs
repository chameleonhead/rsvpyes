...
namespace RsvpYes.Domain.Tests
{
    ...
    public class SettingUpMeetingTests
    {
        ...
        public void Initialize()
        {
            ...
            sut = new MeetingPlan(meetingId, host, "V“üŽÐˆõŠ½Œ}‰ï", createdAt);
            user1 = new UserId();
            user2 = new UserId();
            ...
            place1 = new MeetingPlace(new PlaceId(), "‰ï‹cŽº‚P");
            place2 = new MeetingPlace(new PlaceId(), "‰ï‹cŽº‚Q");
        }

        [TestMethod]
        public void ‰ï‚ðì¬‚·‚é()
        {
            Assert.AreEqual("V“üŽÐˆõŠ½Œ}‰ï", sut.Name);
        ...
        [TestMethod]
        public void ƒƒCƒ“ƒQƒXƒg‚ðÝ’è‚·‚é()
        {
        ...
        [TestMethod]
        public void ‰ï‚ÉŽžŠÔ‚ÌŒó•â‚ðÝ’è‚·‚é()
        {
            sut.AddMainGuest(user1);
        ...
        [TestMethod]
        public void ‰ï‚ÉŽžŠÔ‚ÌŒó•â‚ð•¡”Ý’èŒã1Œ‚É‚È‚é‚æ‚¤‚Éíœ‚·‚é()
        {
            sut.AddMainGuest(user1);
            sut.AddCandidateSchedule(schedule1);
            sut.AddCandidateSchedule(schedule2);
        ...
        [TestMethod]
        public void ‰ï‚ÉŽžŠÔ‚ÌŒó•â‚ð•¡”Ý’èŒã1‚Â‚ð‘I‘ð‚·‚é()
        {
            sut.AddMainGuest(user1);
            sut.AddCandidateSchedule(schedule1);
            sut.AddCandidateSchedule(schedule2);
        ...
        [TestMethod]
        public void ‰ï‚ÉêŠ‚ÌŒó•â‚ðÝ’è‚·‚é()
        {
            sut.AddMainGuest(user1);
        ...
        [TestMethod]
        public void ‰ï‚ÉêŠ‚ÌŒó•â‚ð•¡”Ý’èŒã1Œ‚É‚È‚é‚æ‚¤‚Éíœ‚·‚é()
        {
            sut.AddMainGuest(user1);
            sut.AddCandidatePlace(place1);
            sut.AddCandidatePlace(place2);
        ...
        [TestMethod]
        public void ‰ï‚ÉêŠ‚ÌŒó•â‚ð•¡”Ý’èŒã1‚Â‚ð‘I‘ð‚·‚é()
        {
            sut.AddMainGuest(user1);
            sut.AddCandidatePlace(place1);
            sut.AddCandidatePlace(place2);
